...
<div class="row mt-4 container-box half_container">
    ...
    <div class="container d-sm-none d-md-block" id="last_container"style="background:white; padding-top:1rem; margin-top:2rem;     margin-left: 0; margin-right: 0; max-width: 100%;">
    <table class="table">
        <thead>
        <tr>
            <th scope="col"><b></b></th>
...
<div class="container d-none d-sm-block d-md-none" id="ultimate_container"style="background:white; padding-top:1rem; margin-top:2rem;     margin-left: 0; margin-right: 0; max-width: 100%;">
