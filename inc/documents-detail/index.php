...
<div class="row container box-center container-box py-3 background-white" style="margin-top: 2rem; padding-bottom: 0 !important;">
            ...
            <div class="row container box-center container-box" style="margin-top: 2rem;">
                <div class=" col py-4 border-bottom ">
                    <section class="px-md-2 mx-md-2 dark-grey-text" style="width: 100%;">
                        <p><b>Description:</b> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin at convallis nisi.
                         Etiam sed magna vel felis gravida convallis. Donec ultricies tellus non ligula facilisis tristique id in enim. 
                         In a tristique lacus. In porttitor eros at tellus finibus scelerisque. Morbi vitae neque eu nulla hendrerit finibus vestibulum at nulla.
