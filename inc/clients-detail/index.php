...
<div class="row container box-center container-box py-3 background-none"
     style="margin-top: 2rem; padding-bottom: 0 !important;">
    <div class="py-4 z-depth-1 col justify-content-between" id="background_1"
         style="border-bottom: 2px solid #8c6f49; display: flex">
...
<div class="row mt-4 container box-center container-box container-box half_container background-none"
        ...
        <div class="row justify-content-between" style="height:45px;">
            <div class="d-flex" style="margin-left: 1rem;">
                ...
                <ul class="second_nav second_nav_custom_one pt-2">
                    ...
                    <a class="fas fa-filter d-block d-md-none p-2 mt-2" id="navbarDropdownMenuLink1"
    ...
    <div class="mt-2 last_container_table w-100 d-none d-md-block" style="width: 100%;" id="tableDocuments">
        <table class="table">
            <thead>
            <tr>
                <th scope="col"><b></b></th>
        ...
        <div class="table-footer d-flex justify-content-between align-items-center">
            <button type="button" class="btn btn-sm button z-depth-1 add-button"
                    style="margin-left:1rem; margin-top: -1rem;">CREATE DOCUMENT
            </button>
    ...
    <div class="mt-2 last_container_table w-100 d-none d-md-block" style="width: 100%; margin-top: .5rem !important;" id="tableMilestoness">
        ...
        <div class="table-footer d-flex justify-content-between align-items-center">
            <button type="button" class="btn btn-sm button z-depth-1 add-button"
                    style="margin-left:1rem; margin-top: -1rem;">CREATE MILESTONE
            </button>
            <nav aria-label="Page navigation example">
                <ul class="pagination pagination-sm pg-blue ">
                    <li class="page-item ">
    ...
    <div class="d-block d-md-none w-100" id="tableMilestonesMobile">
        ...
        <div class="card ">
            <div class="card-body d-flex" style="padding:1rem;">
                ...
                <div class="mobile-card-content" style="width:100%;">
                    <h5 class="card-title d-flex justify-content-between mb-0"><p><b>Promissory Contract Payment</b> <br>
                            Ana Humble <br> 20/02/2020</p>
                        <div class="nav-item dropdown">
                            <a class="nav-link fas fa-ellipsis-v main_color" id="navbarDropdownMenuLink"
                               data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false"></a>
        ...
        <div class="card ">
            <div class="card-body d-flex" style="padding:1rem;">
                ...
                <div class="mobile-card-content" style="width:100%;">
                    <h5 class="card-title d-flex justify-content-between mb-0"><p><b>Reservation Fee Reinforcement</b> <br>
                            Ana Humble <br> 20/02/2020</p>
                        <div class="nav-item dropdown">
                            <a class="nav-link fas fa-ellipsis-v main_color" id="navbarDropdownMenuLink"
                               data-toggle="dropdown"
        ...
        <div class="card ">
            <div class="card-body d-flex" style="padding:1rem;">
                ...
                <div class="mobile-card-content" style="width:100%;">
                    <h5 class="card-title d-flex justify-content-between mb-0"><p><b>Welcome Letter</b> <br> Ana Humble <br>
                            20/02/2020</p>
                        <div class="nav-item dropdown">
                            <a class="nav-link fas fa-ellipsis-v main_color" id="navbarDropdownMenuLink"
                               data-toggle="dropdown"
...
<div class="cards_container container container-box box-center mt-2 mb-5 "
     style="width: 100%;background:transparent!important;     margin-bottom: 10rem !important;" id="grid">
    <!-- Card -->
    <div class="card ml-0">
